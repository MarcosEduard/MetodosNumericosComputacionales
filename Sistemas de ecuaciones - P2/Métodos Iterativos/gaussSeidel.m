function [x1, x2, x3, Ea1, Ea2, Ea3] = gaussSeidel(matriz, matriz2, matrizreal, tol, maxIter)
    ...
    for k = 1:maxIter
        a = x1;
        x1 = (matrizreal(1,4) - matrizreal(1,2)*x2 - matrizreal(1,3)*x3) / matrizreal(1,1);
        Ea1 = (abs(x1 - a)*100) / abs(x1);

        b = x2;
        x2 = (matrizreal(2,4) - matrizreal(2,1)*x1 - matrizreal(2,3)*x3) / matrizreal(2,2);
        Ea2 = (abs(x2 - b)*100) / abs(x2);

        c = x3;
        x3 = (matrizreal(3,4) - matrizreal(3,1)*x1 - matrizreal(3,2)*x2) / matrizreal(3,3);
